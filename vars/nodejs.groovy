...
def sonarChecks(){
    sh '''
        ...
        curl https://gitlab.com/thecloudcareers/opensource/-/raw/master/lab-tools/sonar-scanner/quality-gate > sonar-gate-qaulity.sh
        sonar-gate-qaulity.sh admin password 172.31.74.222 ${COMPONENT}
