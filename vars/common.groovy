def sonarChecks(){
    sh '''
        ...
        sonar-scanner -Dsonar.sources=. -Dsonar.java.binaries=target/  -Dsonar.login=50f7343f3f183720df2f8fb67c87dba098f84910 -Dsonar.host.url=http://172.31.74.222:9000 -Dsonar.projectKey=${COMPONENT}
